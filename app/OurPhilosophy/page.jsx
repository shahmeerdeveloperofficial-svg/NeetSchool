...
const OurPhilosophy = () => {
  const cmsData = {
    content: [
      ...
      {
        type: "p",
        text: "NEET School System believes education should strengthen knowledge, behavior, confidence, and values together. A child learns best in a setting where expectations are clear and support is consistent.",
      },
      {
        type: "br",
      },
  ...
  return (
    <main>
      <HeroHeader title={"Our Philosophy"} description="NEET School System" />
